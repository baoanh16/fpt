						...
						<div class="col-lg-7">
							<article class="event-detail">
								...
								<div class="fullcontent">
									<xsl:apply-templates select="/NewsDetail/NewsAttributes" mode="FullContent"></xsl:apply-templates>
								</div>
							</article>
							...
							<div class="tags">
								<a class="tag-title">Tag</a>
								<xsl:apply-templates select="/NewsDetail/Tags"></xsl:apply-templates>
							</div>
							<div class="contact">
								<xsl:apply-templates select="/NewsDetail/NewsAttributes" mode="Contact"></xsl:apply-templates>
							</div>
						</div>
					</div>
